...
- The Dockcheck feature uses menu 97 for status/install/delete/component upgrade and menu 98 for manual image check/update. Avoid reintroducing Watchtower menu entries.
